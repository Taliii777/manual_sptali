  ...
  return (
    ...
    >
      ...
      <div className="space-y-5">
        ...
        <img
                  src="/imagenes/4-ENF-INICIO/2.png"
          ...
          <ol className="list-decimal pl-6 space-y-1">
            ...
            <li>
              Selecciona el caso que deseas ver para ver el detalle e historial del caso médico.
                ...
                <img
                  src="/imagenes/4-ENF-INICIO/4.1.png"
                  className="rounded-lg border shadow-md max-w-full h-auto mx-auto"
                />
                <img
                  src="/imagenes/4-ENF-INICIO/4.2.png"
                  className="rounded-lg border shadow-md max-w-full h-auto mx-auto"
                />
                <img
                  src="/imagenes/4-ENF-INICIO/4.3.png"
                  className="rounded-lg border shadow-md max-w-full h-auto mx-auto"
                />
                  <li>
            ...
            <img
                  src="/imagenes/4-ENF-INICIO/4.0.png"
                  className="rounded-lg border shadow-md max-w-full h-auto mx-auto"
                />
                <img
                  src="/imagenes/4-ENF-INICIO/4.6.png"
                  className="rounded-lg border shadow-md max-w-full h-auto mx-auto"
                />
                <img
                  src="/imagenes/4-ENF-INICIO/4.7.png"
                  className="rounded-lg border shadow-md max-w-full h-auto mx-auto"
                />
            <li>
        ...
        <li>Selecciona <strong>“Historia”</strong> en el caso.</li>
            <img
                  src="/imagenes/4-ENF-INICIO/5.png"
                  className="rounded-lg border shadow-md max-w-full h-auto mx-auto"
                />
